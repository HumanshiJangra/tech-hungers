  ...
  return (
    <header className=' bg-[#3977B7]  '>
      ...
      <div className='nav-container flex items-center justify-between py-3 '>
        ...
        <ul className={`nav-menu lg:flex lg:gap-8 items-center ${isToggleOpen ? 'open block absolute top-0 left-0 w-full bg-blue-500 h-screen overflow-y-auto' : 'hidden'}`}>
          ...
          <li>
            <Link href="/therapistnetwork" className="nav-menu-list">Services</Link>
          </li>
          <li>
            <Link href="/faq" className="nav-menu-list">Technologies</Link>
          </li>
          <li>
            <Link href="/contact" className="nav-menu-list lg:!inline-block lg:text-sm lg:!text-[#3977B7] lg:bg-[#fff] rounded-[30px] lg:!px-[30px] !py-[13px]">Contact</Link>
          </li>
